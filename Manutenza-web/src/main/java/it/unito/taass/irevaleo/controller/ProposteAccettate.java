 ...
 * @author irene
 */
public class ProposteAccettate extends HttpServlet {
	...
	HttpSession s = request.getSession(); //sessione
        ...
        //lavori in corso = proposte del manutente che sono state accettate dall'utente
        List<Proposta> proposteAccettate = gestoreProposte.cercaProposteAccettate(manutente, Utilita.ACCETTATA);
